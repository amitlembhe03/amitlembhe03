...
Highly motivated and detail-oriented DevOps Engineer with a strong foundation in computer applications and 7 months of hands-on experience as a Cloud Engineer Trainee. Proficient in containerized application deployment, CI/CD pipeline processes using Jenkins and Docker, and working within AWS environments. Demonstrated ability to manage and deploy applications on Kubernetes clusters, configure role bindings, and troubleshoot deployment issues. Possess solid understanding of cloud infrastructure, automation tools, and version control systems. Strong problem-solving skills and a passion for optimizing development workflows and ensuring seamless integration and delivery of software solutions.
...
<img align="left" alt="Sonarqube" width="30px" style="padding-right:10px;" src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/sonarqube/sonarqube-plain-wordmark.svg" />
